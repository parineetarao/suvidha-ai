"""add member1 and member2 tables

Revision ID: d32c4df98448
Revises: 8500f0bbe940
Create Date: 2026-07-27 09:55:31.803539
...
def upgrade() -> None:
    ...
    # DISABLED: these tables are duplicates. They are already created by
    # a82a2f043315 (admins, audit_logs, otp_requests, users, refresh_tokens,
    # user_profiles) and 2ac3a903d489 (schemes), merged via 8500f0bbe940.
    # Running these again causes DuplicateTable errors. Commented out rather
    # than deleted so the original migration logic stays visible.
    #
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    # DISABLED: see upgrade() — these drops are commented out to match.
    #
